"""Templates de prompts para cada função do sistema."""
...
{{
  ...
  "problemas": ["lista de problemas encontrados seguido da sugestão de correção ou 'nenhum'"],
  "letra_recebida": "letra COMPLETA que você recebeu"
}}
"""
...
FORMATO DA SAÍDA:
{{"letra": "letra completa corrigida da música"}}
"""
...
ENTREGA:
Retorne APENAS a letra COMPLETA corrigida, sem explicações ou comentários adicionais.

FORMATO DA SAÍDA:
{{"letra": "letra completa e corrigida da música"}}
"""
...
{{
  "status": "aprovado" ou "reprovado",
  "problemas": ["lista de problemas encontrados ou 'nenhum'"],
  "letra_recebida": "letra que você recebeu"
}}
"""
...
AÇÃO ESPERADA:
Forneça uma análise completa seguindo o formato estabelecido, sendo especialmente rigoroso com:
...
Em sua resposta, aponte apenas os problemas e como corrigi-los, NADA além disso.
...
AJUSTADOR_LINGUISTICO_SYSTEM = """Você é um especialista em ajustes finos de letras musicais educativas para o Suno.com. Sua função é corrigir EXCLUSIVAMENTE os problemas apontados pelo validador, mantendo todo o resto da letra intacto.
...
FORMATAÇÃO:
- Remover qualquer indicação entre parênteses ou colchetes
- Eliminar marcações como (Verso), (Refrão), (Bridge)
...
AJUSTADOR_LINGUISTICO_PROMPT = """O validador encontrou problemas na letra abaixo. Corrija EXCLUSIVAMENTE os itens listados nas ressalvas, mantendo todo o resto da letra exatamente como está.
...
4. NÃO altere nada que não foi mencionado nas ressalvas
5. Mantenha título, estrutura e fluidez originais

ENTREGA:
Retorne APENAS a letra COMPLETA corrigida, pronta para uso no Suno.com, sem explicações ou comentários adicionais.
